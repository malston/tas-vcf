...
4. Sets up SSH key: `~/.ssh/vcf_opsman_ssh_key.key`
5. Deploys VM to:
...
- SSH: `ssh -i ~/.ssh/vcf_opsman_ssh_key.key ubuntu@31.31.10.10`
...
# SSH
ssh -i ~/.ssh/vcf_opsman_ssh_key.key ubuntu@31.31.10.10
```
